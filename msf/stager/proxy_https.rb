...
require 'msf/core'
require 'msf/core/handler/proxy_https'
...
module Metasploit3
	...
	def initialize(info = {})
		super(merge_info(info,
			'Name'          => 'Connect over HTTPS through Proxy',
			'Version'       => '$Revision$',
			'Description'   => 'Tunnel communication over HTTP using SSL',
			'Author'        => 'Tom Steele', #i just copied reverse_https and reneamed it...
			'License'       => MSF_LICENSE,
			'Platform'      => 'win',
			'Arch'          => ARCH_X86,
			'Handler'       => Msf::Handler::ProxyHttps,
